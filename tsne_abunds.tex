...
using a gradient-descent method. The result of this optimization is a map that reflects the similarities between the high-dimensional inputs (see e.g. Fig. \ref{harps1}).
...
\begin{figure*}\centering
 \includegraphics[width=0.99\textwidth]{HARPS_tsne_plots_withteffcutmc5040_rand0.png}
...
FA would like to thank Elisa Delgado-Mena for sharing the re-reduced HARPS-GTO data, and Guillaume Guiglion, Katia Cunha, Paula Jofr\'e, Bertrand Lemasle and the other participants of the IAU symposium 334 in Potsdam, as well as David W. Hogg, for their encouragement and/or critical thoughts. 
