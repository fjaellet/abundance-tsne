...
\begin{enumerate}
 ...
 \item Adding ages and/or kinematics to the input parameter space does not significantly aid the t-SNE projection, at least in this special case of very local disc, high-resolution, and high-signal-to-noise data. In the case of moving groups or globular clusters, adding kinematic dimensions to chemical tagging excercises does make a difference (CITE d'Onghia student paper).
\end{enumerate}
...
%The main result of our t-SNE visualisation, the multiple populations found in the high-[$\alpha$/Fe]-sequence, can also be found in other solar-vicinity datasets, as we show in Chiappini et al. (in prep.).
